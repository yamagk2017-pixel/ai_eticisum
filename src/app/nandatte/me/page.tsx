  ...
  return (
    <div className="min-h-screen bg-[var(--ui-page)] text-[var(--ui-text)]">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-16">
        <Link className="text-xs text-[var(--ui-text-subtle)] hover:text-[var(--ui-text)]" href="/nandatte">
          ← ナンダッテ一覧に戻る
        </Link>
        <header className="flex flex-col gap-3">
          ...
          <h1 className="font-mincho-jp text-3xl font-semibold sm:text-4xl">投票したアーティスト</h1>
